...
const SkillsCube = () => {
  ...
  <div className="face right flex items-center bg-opacity-80 justify-center">
    <i className="fab fa-aws fa-3x text-orange-500"></i> {/* AWS icon */}
  </div>
  <div className="face top flex items-center bg-opacity-80 justify-center">
    <i className="fas fa-database fa-3x text-purple-600"></i> {/* Database icon */}
  </div>
  <div className="face bottom flex items-center bg-opacity-80 justify-center">
    <i className="fab fa-docker fa-3x text-blue-400"></i> {/* Docker icon */}
  </div>
</div>
</div>
    </div>
