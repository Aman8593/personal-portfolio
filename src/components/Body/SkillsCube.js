...
const SkillsCube = () => {
  return (
    <div className="flex flex-col items-center px-4 py-8 mb-16 md:mb-8">
      <h2 className="text-2xl font-bold mb-24 text-center text-white-100 dark:text-gray-100">
        My Skills
      </h2>
      <div className="cube-container">
        <div className="cube">
          <div className="face front flex items-center bg-opacity-80 justify-center">
            <i className="fab fa-react fa-3x text-blue-600"></i>{" "}
            {/* React icon */}
          </div>
          <div className="face back flex items-center bg-opacity-80 justify-center">
            <i className="fab fa-cplusplus fa-3x text-blue-700"></i>{" "}
            {/* C++ icon */}
          </div>
          ...
          <div className="face right flex items-center bg-opacity-80 justify-center">
            <i className="fab fa-aws fa-3x text-orange-500"></i>{" "}
            {/* AWS icon */}
          </div>
          <div className="face top flex items-center bg-opacity-80 justify-center">
            <i className="fas fa-database fa-3x text-purple-600"></i>{" "}
            {/* Database icon */}
          </div>
          <div className="face bottom flex items-center bg-opacity-80 justify-center">
            <i className="fab fa-docker fa-3x text-blue-400"></i>{" "}
            {/* Docker icon */}
          </div>
        </div>
      </div>
